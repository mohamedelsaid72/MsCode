<template>
  <div class="project-card-container">
    <div class="project-title">
      ...
      <span class="gray">// _description of project</span>
    </div>
    <div class="project-card">
      <div class="project-image">
        <div class="category-icon">
          <svg
            v-if="project.category === 'vue'"
          ...
          <svg
            v-if="project.category === 'javaScript'"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
            width="18.81px"
      ...
      <div class="project-body">
        <div class="project-description gray">description of project</div>

        <a class="view-project" href="project-url">view-project</a>
      </div>
    </div>
  </div>
</template>
